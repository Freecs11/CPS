...
public class ClientPlugin
                ...
                new AbstractTask() {
                    ...
                    public void run() {
                        try {
                            ...
                            ClientPlugin.this.getOwner().logMessage("Async request sent to node "
    ...
    public void acceptRequestResult(String requestURI, QueryResultI result) throws Exception {
        this.getOwner().logMessage("Received result for request with URI " + requestURI + " at " + Instant.now());
