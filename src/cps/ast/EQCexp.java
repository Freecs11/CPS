...
public class EQCexp extends ABSCExp {
	private ABSRand rand1;
	private ABSRand rand2;

	public EQCexp(ABSRand rand1, ABSRand rand2) {
	...
	public void setRand1(ABSRand rand1) {
		this.rand1 = rand1;
	}
	...
	public void setRand2(ABSRand rand2) {
		this.rand2 = rand2;
	}
